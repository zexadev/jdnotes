...
本文分享 [Lapis](https://github.com/zexadev/lapisnote) 的开发经验——一个基于 Tauri 2 + React 的桌面笔记应用，集成了 AI 助手、MCP Server、SQLite 存储等功能。
...
Lapis 是一个用 Tauri 2 构建的真实项目，完整代码开源在 [GitHub](https://github.com/zexadev/lapisnote)，欢迎参考和贡献。
...
*想体验 Tauri 构建的应用？[下载 Lapis](https://github.com/zexadev/lapisnote/releases) 感受 8MB 安装包的轻量体验。*

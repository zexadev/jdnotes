      ...
      <div className="grid grid-cols-[220px_1fr] gap-5 items-start">
        ...
        <div className="space-y-2 sticky top-0">
          {config.sources.map((source) => {
            ...
            return (
              <div
                ...
                className={`group relative flex items-center gap-2.5 px-3 py-2.5 rounded-lg cursor-pointer transition-all border ${
                  isSelected
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-[11px] text-gray-400 dark:text-gray-500 truncate mt-0.5">
                    {PROVIDER_PRESETS[source.provider]?.name}
                  </div>
                </div>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-1.5 px-3 py-2 text-xs text-gray-500 dark:text-gray-400 border border-dashed border-gray-300 dark:border-gray-600 rounded-lg hover:border-[#5E6AD2] hover:text-[#5E6AD2] transition-colors"
          >
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-center justify-between pb-3 border-b border-gray-200 dark:border-gray-700">
                <div className="flex items-center gap-2">
                  ...
                  {selected.id === config.activeSourceId && (
                ...
                {selected.id !== config.activeSourceId && (
                  <button
                    onClick={() => setActiveSource(selected.id)}
                    className="text-xs px-2.5 py-1 rounded-md border border-[#5E6AD2] text-[#5E6AD2] hover:bg-[#5E6AD2] hover:text-white transition-colors"
                  >
                    设为激活
                  </button>
                )}

...
export function DashboardPage({ onNavigate, onCreateNote }: DashboardPageProps) {
  ...
  return (
    <div className="h-full overflow-y-auto bg-transparent">
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 md:px-8 py-4 md:py-6 lg:py-8">
        {/* 主网格布局 */}
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-4 md:gap-6">
          ...
          <div className="xl:col-span-8 flex flex-col gap-4 md:gap-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-6">
              ...
              {/* 右侧两个小卡片 */}
              <div className="lg:col-span-5 grid grid-cols-2 lg:grid-cols-1 gap-4 md:gap-6">
                <MetricCard
                  icon={Star}
                  title="收藏笔记"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 md:gap-6">
              ...
              <div className="lg:col-span-7">
                <TimeAnalysisCard
                  ...
                  onNavigate={onNavigate}
                  className="h-[300px] sm:h-[340px] lg:h-[360px]"
                />
              </div>
          ...
          {/* 右侧边栏 */}
          <div className="xl:col-span-4 bg-gray-100 dark:bg-[#161722] rounded-2xl sm:rounded-[2.5rem] p-4 sm:p-6 flex flex-col relative overflow-hidden min-h-[600px] xl:h-auto" style={{ maxHeight: 'calc(100vh - 8rem)' }}>
            {/* 装饰性背景光晕 */}
            ...
            <div className="relative z-10 mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="space-y-2 sm:space-y-3">
                <button
                  ...
                  className="w-full bg-white dark:bg-[#1f2029] p-2.5 sm:p-3 rounded-xl sm:rounded-2xl flex items-center justify-between border border-transparent hover:border-gray-300 dark:hover:border-gray-700 transition-all hover:shadow-md active:scale-95"
                >
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-green-500/20 flex items-center justify-center">
                      <BookOpen className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-green-600 dark:text-green-400" strokeWidth={2} />
                    </div>
                    <div className="text-left">
                      <p className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white leading-tight">
                        新建笔记
                      </p>
                      <p className="text-[9px] sm:text-[10px] text-gray-500">快速创建</p>
                    </div>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-yellow-500/20 flex items-center justify-center">
                      <Star className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-yellow-600 dark:text-yellow-400" strokeWidth={2} />
                    </div>
                    <div className="text-left">
                      <p className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white leading-tight">
                        我的收藏
                ...
                >
                  <div className="flex items-center gap-2 sm:gap-3">
                    <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-blue-500/20 flex items-center justify-center">
                      <CalendarIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-blue-600 dark:text-blue-400" strokeWidth={2} />
                    </div>
                    <div className="text-left">
                      <p className="text-xs sm:text-sm font-semibold text-gray-900 dark:text-white leading-tight">
                        日历视图
            ...
            {/* 最近笔记区域 */}
            <div className="relative z-10 mt-4 sm:mt-6 pt-4 sm:pt-6 border-t border-gray-200 dark:border-gray-700 flex-1 flex flex-col min-h-0">
              {/* 笔记列表 - 可滚动 */}
              <div className="flex-1 overflow-y-auto -mx-1 sm:-mx-2 px-1 sm:px-2">
                <RecentActivityCard
